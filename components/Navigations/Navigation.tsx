...
import { CgClose, CgWorkAlt } from "react-icons/cg";
import { TbCode, TbFileCertificate, TbHome } from "react-icons/tb";
...
const Navigation = () => {
  ...
  return (
    <div className='mt-12 pb-2 flex flex-row justify-between border-b-[1px] border-[#27272a] font-noto tracking-wide'>
      <div className='flex flex-row select-none ease-linear duration-100'>
        ...
        >
          <div className='flex flex-row items-center justify-center space-x-2'>
            ...
            <div className='hidden md:flex'>Work Experience / Achievements</div>
          </div>
        </div>
      ...
      />
      <Link href='https://drive.google.com/file/d/172ESjs5gJ2VWlVQFFKFhCtB7SWUFEKPB/view?usp=sharing' download={'resume'} target="_blank">
        <button
          // onClick={notify}
